...
class UserController {
 ...
 async uploadProfilePicture(
   ...
   try {
     ...
     // TODO: Replace with Cloudinary upload before production
     // const photoUrl = await cloudinaryService.uploadImage(file.buffer, `hallmate/profiles/${userId}`);
     const photoUrl = 'https://placeholder-url.com/photo.jpg';

     const user = await userService.uploadProfilePicture(userId, photoUrl, req.user.userId);
 ...
 async deleteProfilePicture(
   ...
   try {
     ...
     const { userId } = req.params;
     const user = await userService.deleteProfilePicture(userId, req.user.userId);
