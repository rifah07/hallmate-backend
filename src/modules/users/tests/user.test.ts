...
describe('User Module', () => {
  ...
  describe('Bulk Upload from Excel/CSV', () => {
    ...
    describe('POST /api/users/bulk-upload', () => {
      // Create a minimal valid CSV content
      ...
      it('should handle partial failures gracefully', async () => {
        const csvBuffer = createCSV([
          ...
          'SHORT,csv5@test.com,Short ID,STUDENT,01712345678,CSE,1,UNDERGRADUATE,2023-24',
        ]);
      ...
      it('should reject file with no valid users', async () => {
        const csvBuffer = createCSV([
          'SHORT,invalid,Bad Name,INVALID_ROLE,01712345678,CSE,1,UNDERGRADUATE,2023-24',
        ]);
      ...
      it('should allow provost to upload', async () => {
        const csvBuffer = createCSV([
          '7777777777,provost-upload@test.com,Provost Upload,STUDENT,01712345678,CSE,1,UNDERGRADUATE,2023-24',
        ]);
